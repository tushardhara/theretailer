...
if ( $attachment_ids ) {
	...
	<div class="thumbnails"><?php
		...
		foreach ( $attachment_ids as $attachment_id ) {
			...
			//echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<a href="%s" title="%s"  >%s</a>', $image_link, $image_title, $image ), $attachment_id, $post->ID, $image_class );
